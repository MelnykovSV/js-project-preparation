 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Yn;const Jn={};class Qn{static get Default(){return y(Jn&&zn,"ChildrenNode.ts has not been loaded"),Yn=Yn||new Qn({".priority":Jn},{".priority":zn}),Yn}get(e){const t=ee(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Ln?t:null}hasIndex(e){return Z(this.indexSet_,e.toString())}addIndex(e,t){y(e!==Dn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(Nn.Wrap);let r,o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Gn(n,e.getCompare()):Jn;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const l=Object.assign({},this.indexes_);return l[a]=r,new Qn(l,c)}addToIndexes(e,t){const n=ne(this.indexes_,((n,i)=>{const s=ee(this.indexSet_,i);if(y(s,"Missing index implementation for "+i),n===Jn){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(Nn.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Gn(n,s.getCompare())}return Jn}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new Nn(e.name,i))),s.insert(e,e.node)}}));return new Qn(n,this.indexSet_)}removeFromIndexes(e,t){const n=ne(this.indexes_,(n=>{if(n===Jn)return n;{const i=t.get(e.name);return i?n.remove(new Nn(e.name,i)):n}}));return new Qn(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pi{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Ri(e,t,n,i,s,r){const o=i.filter((e=>e.type===n));o.sort(((t,n)=>function(e,t,n){if(null==t.childName||null==n.childName)throw w("Should only compare child_ events.");const i=new Nn(t.childName,t.snapshotNode),s=new Nn(n.childName,n.snapshotNode);return e.index_.compare(i,s)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hs=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class us{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Ni(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return os(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Li(this.viewCache_),s=rs(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const go={};let mo=!1;function vo(t,n,i,s,r){let o=s||t.options.databaseURL;void 0===o&&(t.options.projectId||Pt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),kt("Using default host for project ",t.options.projectId),o=`${t.options.projectId}-default-rtdb.firebaseio.com`);let a,c,l=no(o,r),h=l.repoInfo;void 0!==e&&e.env&&(c=e.env.FIREBASE_DATABASE_EMULATOR_HOST),c?(a=!0,o=`http://${c}?ns=${h.namespace}`,l=no(o,r),h=l.repoInfo):a=!l.repoInfo.secure;const u=r&&a?new zt(zt.OWNER):new Bt(t.name,t.options,n);Pr("Invalid Firebase Database URL",l),yn(l.path)||Pt("Database URL must point to the root of a Firebase Database (not including a child path).");const d=function(e,t,n,i){let s=go[t.name];s||(s={},go[t.name]=s);let r=s[e.toURLString()];r&&Pt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new Lr(e,mo,n,i),s[e.toURLString()]=r,r}(h,t,u,new Vt(t.name,i));return new yo(d,t)}class yo{get _repo(){return this._instanceStarted||(Mr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new co(this._repo,un())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=go[t];n&&n[e.key]===e||Pt(`Database ${t}(${e.repoInfo_}) has already been deleted.`),Br(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&Pt("Cannot call "+e+" on a deleted database.")}constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}}function wo(e=nt(),t){const n=Xe(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const e=D("database");e&&function(e,t,n,i={}){(e=ge(e))._checkNotDeleted("useEmulator"),e._instanceStarted&&Pt("Cannot call useEmulator() after instance has already been initialized.");const s=e._repoInternal;let r;if(s.repoInfo_.nodeAdmin)i.mockUserToken&&Pt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),r=new zt(zt.OWNER);else if(i.mockUserToken){const t="string"==typeof i.mockUserToken?i.mockUserToken:L(i.mockUserToken,e.app.options.projectId);r=new zt(t)}!function(e,t,n,i){e.repoInfo_=new Kt(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),i&&(e.authTokenProvider_=i)}(s,t,n,r)}(n,...e)}return n}Sn.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Sn.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */)(r)||ba(r,h.measurementId),Ra&&(s("consent","default",Ra),Aa(void 0)),s("js",new Date);const d=null!==(a=null==o?void 0:o.config)&&void 0!==a?a:{};return d.origin="firebase",d.update=!0,null!=u&&(d.firebase_id=u),s("config",h.measurementId,d),Pa&&(s("set",Pa),Da(void 0)),h.measurementId}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Mh=O("authIdTokenMaxAge")||300;let Fh=null;var Uh;Uh="Browser",Qe(new me("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:r,authDomain:o}=n.options;tc(r&&!r.includes(":"),"invalid-api-key",{appName:n.name}),tc(!(null==o?void 0:o.includes(":")),"argument-error",{appName:n.name});const a={apiKey:r,authDomain:o,clientPlatform:Uh,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:$c(Uh)},c=new tl(n,i,s,a);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(Rc);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(c,t),c}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Qe(new me("auth-internal",(e=>{const t=nl(e.getProvider("auth").getImmediate());return new Lh(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),it("@firebase/auth","0.23.1",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Uh)),it("@firebase/auth","0.23.1","esm2017");const qh={favourite:[],read:[],theme:"light"},jh=tt({apiKey:"AIzaSyAdDj9F_jubuCOC76pSoibdy_DVCdFqGhQ",authDomain:"js-project-preparation.firebaseapp.com",databaseURL:"https://js-project-preparation-default-rtdb.europe-west1.firebasedatabase.app",projectId:"js-project-preparation",storageBucket:"js-project-preparation.appspot.com",messagingSenderId:"476626012391",appId:"1:476626012391:web:081c79df589d1579103a42",measurementId:"G-8S7FQJPFG2"}),Wh=(function(e=nt()){const t=Xe(e=ge(e),"analytics");t.isInitialized()?t.getImmediate():function(e,t={}){const n=Xe(e,"analytics");if(n.isInitialized()){const e=n.getImmediate();if(ie(t,n.getOptions()))return e;throw ya.create("already-initialized")}n.initialize({options:t})}(e)}(jh),function(e=nt()){const t=Xe(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Xe(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(ie(n.getOptions(),null!=t?t:{}))return e;Qa(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:xh,persistence:[Ql,Fl,ql]}),i=O("authTokenSyncURL");if(i){const e=(s=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Mh)return;const i=null==t?void 0:t.token;Fh!==i&&(Fh=i,await fetch(s,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){ge(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){ge(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var s;const r=A("auth");return r&&sl(n,`http://${r}`),n}(jh)),Hh=document.querySelector(".auth-component");var Vh=new class{signUp(e){e.preventDefault(),Hh.classList.remove("signed-out");const t=e.target.elements.email.value,n=e.target.elements.password.value;Dl(Wh,t,n).then((e=>{e.user})).catch((e=>{e.code;const t=e.message;console.log(t),Hh.classList.add("signed-out")})).finally((()=>{e.target.classList.add("visually-hidden")}))}signIn(e){e.preventDefault(),Hh.classList.remove("signed-out");const t=e.target.elements.email.value,n=e.target.elements.password.value;Ol(Wh,t,n).then((e=>{e.user;console.log("signed in"),Bh.getUserData().then((e=>{e?Kh.set(e):Kh.set(qh)}))})).catch((e=>{e.code;const t=e.message;console.log(t)})).finally((()=>{e.target.classList.add("visually-hidden")}))}signOutUser(){var e;Hh.classList.remove("signed-in"),(e=Wh,ge(e).signOut()).then((()=>{console.log("Sign-out successful"),localStorage.getItem("globalState")?Kh.set(JSON.parse(localStorage.getItem("globalState"))):(Kh.set(qh),Kh.writeToLocalStorage())})).catch((e=>{Hh.classList.add("signed-in"),console.log("An error happened")}))}checkUserStatus(){xl(Wh,(e=>{if(e){e.uid;Bh.getUserData().then((e=>{e?Kh.set(e):Kh.set(qh)})),Hh.querySelector(".auth-component__user-email").textContent=`${e.email}`,console.log("user is in system"),Hh.classList.add("signed-in")}else localStorage.getItem("globalState")?Kh.set(JSON.parse(localStorage.getItem("globalState"))):(Kh.set(qh),Kh.writeToLocalStorage()),console.log("user signied out"),Hh.classList.add("signed-out")}))}isAuthenticated(){return new Promise((e=>{xl(Wh,(t=>{e(!!t)}))}))}getCurrentUserId(){const e=Wh.currentUser;if(null!==e)return console.log("get id"),console.log(e),e.uid}};wo(tt({apiKey:"AIzaSyAdDj9F_jubuCOC76pSoibdy_DVCdFqGhQ",authDomain:"js-project-preparation.firebaseapp.com",databaseURL:"https://js-project-preparation-default-rtdb.europe-west1.firebasedatabase.app",projectId:"js-project-preparation",storageBucket:"js-project-preparation.appspot.com",messagingSenderId:"476626012391",appId:"1:476626012391:web:081c79df589d1579103a42",measurementId:"G-8S7FQJPFG2"}));var Bh=new class{writeUserData(){const e=Vh.getCurrentUserId(),t=Kh.get();console.log("WRITTEN DATA"),console.log(t);po(ho(wo(),"users/"+e),t)}async getUserData(){const e=Vh.getCurrentUserId(),t=wo();return await fo(ho(t,"users/"+e)).then((t=>{if(t.exists()){console.log(`READ DATA FROM: ${e}`),console.log(t.val());return{...qh,...t.val()}}console.log("No data available")})).catch((e=>{console.error(e)}))}};let zh,$h=JSON.parse(JSON.stringify(qh));var Kh=Object.freeze(new class{get(){return $h}set(e){$h=JSON.parse(JSON.stringify(e)),console.log("SET"),console.log($h),this.saveData()}favourite(){return $h.favourite}read(){return $h.read}theme(){return $h.read}async setFavourite(e){$h.favourite=e,this.saveData()}setRead(e){$h.read=e,this.saveData()}setTheme(e){$h.theme=e,this.saveData()}writeToLocalStorage(){localStorage.setItem("globalState",JSON.stringify($h))}async saveData(){const e=await Vh.isAuthenticated();console.log(e),e?Bh.writeUserData():this.writeToLocalStorage()}constructor(){if(zh)throw new Error("New instance cannot be created!!");zh=this}});const Gh=document.querySelector(".auth-component"),Yh=document.querySelector(".sign-up-form"),Jh=document.querySelector(".sign-in-form"),Qh=document.querySelector(".test-button"),Xh=document.querySelector(".state-button");Vh.checkUserStatus(),Yh.addEventListener("submit",Vh.signUp),Jh.addEventListener("submit",Vh.signIn),Gh.addEventListener("click",(e=>{e.target.classList.contains("auth-component__sign-out-button")&&Vh.signOutUser(),e.target.classList.contains("auth-component__sign-up-button")&&Yh.classList.remove("visually-hidden"),e.target.classList.contains("auth-component__sign-in-button")&&Jh.classList.remove("visually-hidden")})),Qh.addEventListener("click",(()=>{Vh.getCurrentUserId()})),Xh.addEventListener("click",(()=>{console.log(Kh.get())}));document.querySelector(".state-manipulator").addEventListener("click",(e=>{switch(e.target.className){case"add-to-favourite":Kh.setFavourite([...Kh.favourite(),{title:"some title",text:"some text"}]);break;case"remove-from-favourite":const e=Kh.favourite();e.pop(),Kh.setFavourite(e);break;case"add-to-read":Kh.setRead([...Kh.read(),{title:"some title",text:"some text"}]);break;case"remove-from-read":const t=Kh.read();t.pop(),Kh.setRead(t);break;case"light-theme":Kh.setTheme("light");break;case"dark-theme":Kh.setTheme("dark");break;case"other-theme":Kh.setTheme("other")}}));
//# sourceMappingURL=index.695e28be.js.map
